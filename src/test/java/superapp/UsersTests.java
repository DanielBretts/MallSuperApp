...
public class UsersTests {
	...
	public void teardown() {
		this.restTemplate
			.delete(this.baseUrl + "/superapp/admin/users");
	}
	...
	public void testSuccessfulCreateUser() throws Exception{
		...
		UserBoundary userEntityFromDb = this.restTemplate.getForObject(this.baseUrl + "/superapp/users/login/2023b.shir.zur/daniel@mail.com", UserBoundary.class);	
		assertThat(userEntityFromDb)
			.isNotNull()
			.extracting("userId.email", "role", "username", "avatar")
//			.isEqualTo(newMessage.getMessage());
			.containsExactly(newUserBoundary.getEmail(), newUserBoundary.getRole(), newUserBoundary.getUsername(), newUserBoundary.getAvatar());
	}
	...
	public void testGettingUser() throws Exception{
		...
		UserBoundary userBoundary = 
		  this.restTemplate
			.getForObject(this.baseUrl + "/superapp/users/login/2023b.shir.zur/daniel@mail.com", UserBoundary.class);
	...
	public void testUpdateUser() throws Exception{
		...
		// AND a user with an email "daniel@mail.com" is exists in the database
			...
			this.restTemplate.postForObject(this.baseUrl + "/superapp/users", newUserBoundary, NewUserBoundary.class);
		// WHEN I PUT /superapp/users/2023b.shir.zur/daniel@mail.com with different username
		...
		// THEN the user's username will be modified in the database
		  ...
		  assertThat(userFromDB)
			.isNotNull()
			.extracting("username")
			.isNotEqualTo(newUserBoundary.getUsername());
		  }
}
